...
export class CardsPageComponent implements OnInit {
  ...
  ngOnInit() {
    this.cards = [
      ...
      new ClientCardModel("7566 7245 2364 3245", "Marc Mikel Garcia", 75671, 4321, 15435, 2343241, "assets/bml-visa-debito-1.png"),
      new ClientCardModel("3453 5451 4773 2435", "Roger Ferran Garcia", 5451, 1565, 65641, 123432, "assets/bml-visa-debito-1.png"),
      new ClientCardModel("8775 3253 4654 2647", "Mikel Carles Garcia", 23431, 5461, 345341, 234321, "assets/bml-visa-debito-1.png"),
      new ClientCardModel("3423 1343 3455 2145", "Ariel Alex Garcia", 1756756, 65461, 15345, 22341, "assets/bml-visa-debito-1.png"),
      new ClientCardModel("0898 1234 7764 4324", "Pepe Machinegun Garcia", 1345345, 12323, 23421, 234431, "assets/bml-visa-debito-1.png"),
    ];
